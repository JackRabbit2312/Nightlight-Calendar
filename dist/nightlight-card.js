...
return css`
   ...
   :host([mode="section"]) { width: 100% !important; position: absolute; z-index: 100; pointer-events: none; transition: width 0.3s ease; }
   :host([mode="section"]) .nightlight-hub { grid-template-columns: 0px 1fr !important; transition: width 0.3s ease; }
   :host([mode="section"]) .side-rail { pointer-events: auto; border-right: none !important; box-shadow: none !important;}
